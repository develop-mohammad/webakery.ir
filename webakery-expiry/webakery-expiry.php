 ...
 * Description: بچ قیمت، موجودی و تاریخ انقضای ووکامرس با سوییچ خودکار رزرو — امکانات با نسخه پرو یکسان است.
 * Version:     1.2.18
...
if ( version_compare( PHP_VERSION, '7.4', '<' ) ) {
	add_action(
		...
		function () {
			...
			echo '<div class="notice notice-error"><p><strong>انقضای کالا:</strong> نیاز به PHP 7.4 یا بالاتر دارد.</p></div>';
		}
	);
	return;
}
