...
<div class="wrap wbe-wrap wbe-help-wrap" dir="rtl">
	...
	<div class="wbe-help-grid">
		...
		<section class="wbe-help-card">
			...
			<p class="description">ذخیره تکه‌تکه انجام می‌شود تا تایم‌اوت نگیرد. محصول متغیر در جدول به ردیف‌های تنوع شکسته می‌شود. ستون «کل موجودی» جمع موجودی فعال و رزرو است. مبالغ نوار بالا به‌صورت پیش‌فرض تا ۲ رقم اعشار گرد می‌شوند.</p>
		</section>
