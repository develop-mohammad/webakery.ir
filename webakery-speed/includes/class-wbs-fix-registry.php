	...
	public static function all() {
		return array(
			'defer_js' => array(
				...
				'risk'        => 'low',
				'audits'      => array( 'render-blocking-resources', 'unused-javascript', 'bootup-time', 'mainthread-work-breakdown', 'total-blocking-time', 'max-potential-fid', 'interactive' ),
			...
			'preload_lcp' => array(
				...
				'risk'        => 'medium',
				'audits'      => array( 'largest-contentful-paint-element', 'lcp-lazy-loaded', 'largest-contentful-paint', 'first-contentful-paint', 'speed-index' ),
