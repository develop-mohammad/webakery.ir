...
define( 'LS_PRICES', [
    ...
    'webakery-chat' => 1990000,   // چت باکس — قیمت پیش‌فرض = ماهانه ۱۹۹,۰۰۰ تومان
] );

// ─── پلن‌های اشتراکی (ماهانه / چندماهه) — اگر برای محصول تعریف شود، پرداخت مادام‌العمر نیست ───
// months: مدت اشتراک | price: ریال | label: متن نمایشی
define( 'LS_PLANS', [
    'webakery-chat' => [
        '1m' => [
            'months' => 1,
            'price'  => 1990000, // ۱۹۹,۰۰۰ تومان
            'label'  => 'ماهانه',
            'hint'   => '۱ ماه دسترسی + آپدیت و پشتیبانی',
        ],
        '3m' => [
            'months' => 3,
            'price'  => 5050000, // ۵۰۵,۰۰۰ تومان
            'label'  => '۳ ماهه',
...
define( 'LS_PLUGIN_META', [
    ...
    'webakery-chat' => [
        'icon' => '💬',
        'desc' => 'چت باکس اشتراکی — ماهانه یا ۳ ماهه + اعلان تلگرام/واتساپ',
    ],
] );
...
define( 'LS_UPDATES', [
    ...
    'webakery-chat' => [
        ...
        'tested'       => '6.7',
        'requires_php' => '7.4',
        'changelog'    => 'نسخه ۱.۴.۱: لایسنس اشتراکی ماهانه و ۳ ماهه.',
    ],
] );
