...
<div class="nm-panel-card">
	...
	<p>مرچنت زرین‌پال (با خط تیره) را اینجا نگذارید — فقط مرچنت مخصوص زیبال. در غیر این‌صورت خطای <code>invalid merchant</code> می‌گیرید و افزونه خودکار به زرین‌پال/ووکامرس سوییچ می‌کند.</p>
</div>
<div class="nm-panel-card">
	<h3>ووکامرس</h3>
