	...
	public static function shortcode_guide() {
		return array(
			array(
				...
				'pay'   => 'بعد از ثبت، سفارش در ووکامرس و حسابدار ساخته می‌شود و کاربر مستقیم به درگاه بانک می‌رود.',
			),
			array(
				'code'  => '[nahal_hall]',
				'title' => 'اجاره سالن',
				...
				'pay'   => 'بعد از ثبت، مبلغ اجاره در ووکامرس و حسابدار ثبت می‌شود و کاربر مستقیم به درگاه بانک می‌رود.',
			),
			array(
				...
				'pay'   => 'اگر مبلغ شهریه باشد، سفارش در ووکامرس و حسابدار ثبت و به درگاه بانک می‌رود.',
			),
			array(
				...
				'pay'   => 'اگر پرداخت فرم روشن باشد، سفارش ثبت و مستقیم به درگاه بانک می‌رود.',
			),
			array(
				'code'  => '[nahal_portal]',
				'title' => 'پورتال عضو',
