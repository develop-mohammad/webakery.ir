...
<div class="wbgs-grid">
	...
	<section class="wbgs-card">
		...
		<p class="wbgs-hint">اول عبارت‌ها به دسته محصول، محصول و برند جدا می‌شوند؛ بعد اینتنت (اطلاعاتی / تجاری / تراکنشی / ناوبری). ذکر فروشگاه کنار دسته مثل «کفش دیجی کالا» ناوبری نیست. امتیاز رقابت نسبی از خودِ عبارت است (KD اهرفس نیست). عدد ماهانه فقط از Keyword Planner می‌آید؛ وگرنه «—» می‌ماند.</p>
		<?php
