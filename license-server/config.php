...
define( 'LS_PLUGIN_META', [
    ...
    'webakery-expiry' => [
        'icon' => '📆',
        'desc' => 'قیمت رزرو، موجودی و تاریخ انقضا با سوییچ خودکار — webakery.ir',
    ],
] );
...
define( 'LS_UPDATES', [
    ...
    'webakery-expiry' => [
        ...
        'tested'       => '6.7',
        'requires_php' => '7.4',
        'changelog'    => 'نسخه ۱.۱.۰: ویرایش گروهی سریع — جدول یکجا و ذخیرهٔ تکه‌تکه برای قیمت، تخفیف، جشنواره، موجودی و انقضا.',
    ],
] );
