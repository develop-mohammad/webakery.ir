...
ورود و ثبت‌نام با شماره موبایل (OTP) و جیمیل / گوگل.
...
- پنل پیامک: ملی‌پیامک، کاوه‌نگار، IPPanel، قاصدک

برای ثبت محصول روی سرور لایسنس، فایل `license-server-updates/ADD-WEBAKERY-LOGIN.md` را ببینید.
