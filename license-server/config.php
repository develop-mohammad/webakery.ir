...
define( 'LS_PRICES', [
    ...
    'nahal-cowork'  => 3990000,   // قرارداد نهال — ۳۹۹,۰۰۰ تومان
] );
...
define( 'LS_UPDATES', [
    ...
    'nahal-cowork' => [
        ...
        'tested'       => '6.7',
        'requires_php' => '7.4',
        'changelog'    => 'نسخه ۱.۲.۸: تقویم ماهانه اجاره سالن ساعت‌های پر را نشان می‌دهد؛ پرداخت کاربر فقط از درگاه سایت است؛ هر فرم سفارشی یک محصول ووکامرس می‌سازد.',
    ],
] );
