...
define( 'LS_UPDATES', [
    ...
    'hesabdar' => [
        ...
        'tested'       => '6.7',
        'requires_php' => '7.4',
        'changelog'    => 'نسخه ۱.۱۱.۰: داشبورد تصویری (ناخالص/خالص، منبع ورود گوگل/سوشال، مشتریان ثابت، پرفروش، پیک خرید) + درگاه‌های زیبال/ترب‌پی/اسنپ‌پی/دیجی‌پی/آیدی‌پی با کارمزد مستند؛ حذف UI گوگل‌شیت و فرمول کم‌کاربرد.',
    ],
    'nobat-man' => [
        'version'      => '1.0.13',
