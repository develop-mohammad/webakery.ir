...
<div class="wrap wbl-admin" dir="rtl">
	...
	<form method="post" class="wbl-admin-form">
		...
		<input type="hidden" name="wbl_tab" value="<?php echo esc_attr( $tab ); ?>" />
			...
			<table class="form-table" role="presentation">
				...
				<tr>
					...
					<td>
						...
						— سقف ساعتی هر IP: <input type="number" min="5" max="100" name="settings[otp_ip_hourly_limit]" value="<?php echo esc_attr( $s['otp_ip_hourly_limit'] ); ?>" />
					</td>
				</tr>
				<tr>
					<th>تست ارسال</th>
