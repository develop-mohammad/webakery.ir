...
<div class="wdp-grid wdp-grid-2">
	...
	<div class="wdp-card-box">
		...
		<ul class="wdp-guide">
			...
			<li>اگر بازه دو صفحه با هم هم‌پوشانی داشته باشد، صفحه با «اولویت» بیشتر و سپس بازه باریک‌تر انتخاب می‌شود.</li>
			<li>هر محصول همیشه فقط در یک صفحه تخفیف قرار می‌گیرد؛ با تغییر تخفیف، از صفحه قبلی خودکار خارج می‌شود.</li>
		</ul>
	</div>
