...
<div class="<?php echo esc_attr( $panel_class ); ?>" id="wbe-product-panel" dir="rtl" data-calendar="<?php echo esc_attr( $effective ); ?>" data-wc-price="<?php echo esc_attr( isset( $wc_price ) ? $wc_price : '' ); ?>">
	...
	<div class="wbe-active-box">
		...
		<p class="description">موجودی این باکس همان موجودی ووکامرس است (محصول ساده یا هر تنوع). با ذخیره، روی ووکامرس SET می‌شود. وقتی این بچ تمام شود، موجودی بچ رزرو بعدی جایگزین موجودی ووکامرس می‌شود. قیمت و انقضای فعال روی فروشگاه دیده می‌شود.</p>
