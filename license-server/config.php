...
define( 'LS_PRICES', [
    ...
    'webakery-chat' => 5050000,   // چت باکس — ۵۰۵,۰۰۰ تومان
] );
...
define( 'LS_PLUGIN_META', [
    ...
    'webakery-chat' => [
        'icon' => '💬',
        'desc' => 'ویجت چت RTL، صندوق پیام، اعلان تلگرام/واتساپ/ایمیل و زمینه محصول',
    ],
] );
...
define( 'LS_UPDATES', [
    ...
    'webakery-chat' => [
        ...
        'tested'       => '6.7',
        'requires_php' => '7.4',
        'changelog'    => 'نسخه ۱.۴.۰: سیستم لایسنس مثل سایر افزونه‌ها — قیمت ۵۰۵,۰۰۰ تومان.',
    ],
] );
