...
<div class="wrap wbe-wrap wbe-help-wrap" dir="rtl">
	...
	<div class="wbe-help-grid">
		<section class="wbe-help-card">
			...
			<ul>
				<li><strong>موجودی فعال:</strong> همان موجودی ووکامرس محصول ساده یا هر تنوع — نزدیک‌ترین انقضا روی فروشگاه دیده می‌شود.</li>
		...
		<section class="wbe-help-card">
			...
			<ul>
				<li>قیمت، تخفیف، جشنواره، موجودی و انقضا را اینجا عوض کنید.</li>
				<li>همان باکس در <strong>ویرایش سریع</strong> لیست محصولات هم هست.</li>
				<li>نام، SKU و وضعیت را از همین صفحه ووکامرس یا از <strong>ویرایش گروهی</strong> عوض کنید.</li>
				<li>محصول متغیر: برای <strong>هر تنوع</strong> جداگانه بچ بگذارید (نه روی والد). موجودی هر تنوع از موجودی ووکامرس همان تنوع خوانده می‌شود.</li>
			</ul>
		</section>
		...
		<section class="wbe-help-card">
			...
			<p class="description">ذخیره تکه‌تکه انجام می‌شود تا تایم‌اوت نگیرد. محصول متغیر در جدول به ردیف‌های تنوع شکسته می‌شود. ستون موجودی فعال از ووکامرس می‌آید. ستون «کل موجودی» جمع موجودی فعال و رزرو است. مبالغ نوار بالا به‌صورت پیش‌فرض تا ۲ رقم اعشار گرد می‌شوند.</p>
		</section>
		...
		<section class="wbe-help-card">
			...
			<ul>
				...
				<li>شورت‌کد: <code>[webakery_expiry]</code> — روی محصول متغیر اگر فرم انتخاب تنوع نباشد، نزدیک‌ترین انقضا نشان داده می‌شود.</li>
			</ul>
		</section>

		<section class="wbe-help-card">
			<h2>۵. تقویم تاریخ و کپی تنوع</h2>
			<ul>
				<li>روی فیلد تاریخ کلیک کنید؛ تقویم شمسی یا میلادی باز می‌شود.</li>
				<li>اگر تاریخ نامعتبر ذخیره شود، بچ قبلی پاک نمی‌شود و یک اعلان زرد می‌بینید.</li>
				<li>روی هر تنوع دکمهٔ <strong>کپی بچ‌ها به همه تنوع‌ها</strong> همان قیمت، موجودی و انقضا را روی بقیه تنوع‌ها می‌گذارد.</li>
			</ul>
		</section>
