	...
	public static function all() {
		return array(
			'defer_js' => array(
				...
				'risk'        => 'low',
				'audits'      => array( 'render-blocking-resources', 'render-blocking-insight', 'unused-javascript', 'bootup-time', 'mainthread-work-breakdown', 'total-blocking-time', 'max-potential-fid', 'interactive', 'forced-reflow-insight' ),
			...
			'async_css' => array(
				...
				'risk'        => 'medium',
				'audits'      => array( 'render-blocking-resources', 'render-blocking-insight', 'unused-css-rules' ),
			...
			'lazyload' => array(
				...
				'risk'        => 'low',
				'audits'      => array( 'offscreen-images', 'uses-optimized-images', 'image-delivery-insight' ),
			...
			'font_display' => array(
				...
				'description' => __( 'برای Google Fonts، فونت‌ایران، Bunny و همه @font-face مقدار swap اعمال می‌شود.', 'webakery-speed' ),
				'risk'        => 'low',
				'audits'      => array( 'font-display', 'font-display-insight' ),
			...
			'preconnect' => array(
				...
				'risk'        => 'low',
				'audits'      => array( 'uses-rel-preconnect', 'network-requests', 'network-dependency-tree-insight', 'server-response-time', 'experimental_time_to_first_byte' ),
			...
			'cache_headers' => array(
				...
				'risk'        => 'low',
				'audits'      => array( 'uses-long-cache-ttl', 'efficient-cache-policy', 'cache-insight' ),
			...
			'preload_lcp' => array(
				...
				'risk'        => 'medium',
				'audits'      => array( 'largest-contentful-paint-element', 'lcp-lazy-loaded', 'largest-contentful-paint', 'first-contentful-paint', 'speed-index', 'lcp-breakdown-insight' ),
