...
define( 'LS_PRICES', [
    ...
    'daftarchi'     => 4990000,   // دفترچی — پیش‌فرض پلن سه‌ماهه ۴۹۹,۰۰۰ تومان
] );

// ─── پلن‌ها (اشتراکی / دائمی) — months=0 یعنی لایسنس مادام‌العمر ───
// months: مدت اشتراک | price: ریال | label: متن نمایشی
define( 'LS_PLANS', [
    'webakery-chat' => [
        '1m' => [
            'months' => 1,
            'price'  => 1500000, // ۱۵۰,۰۰۰ تومان
            'label'  => 'ماهانه',
            'hint'   => '۱ ماه دسترسی + آپدیت و پشتیبانی',
        ],
        '3m' => [
            'months' => 3,
            'price'  => 3500000, // ۳۵۰,۰۰۰ تومان
            'label'  => '۳ ماهه',
    ...
    'daftarchi' => [
        '1m' => [
            ...
            'price'  => 1990000,
            'label'  => 'یک‌ماهه',
            'hint'   => '۱ ماه — برای شروع فروشگاه',
        ],
        '3m' => [
            'months' => 3,
            'price'  => 4990000,
            'label'  => 'سه‌ماهه',
            'hint'   => '۳ ماه — به‌صرفه‌تر از سه بار ماهانه',
            'badge'  => 'پیشنهادی',
        ],
        '12m' => [
            'months' => 12,
            'price'  => 14900000,
            'label'  => 'یک‌ساله',
            'hint'   => '۱۲ ماه — کمترین هزینهٔ ماهانه',
        ],
    ],
] );
...
define( 'LS_PLUGIN_LABELS', [
    ...
    'daftarchi'     => 'دفترچی — حسابداری دسکتاپ فروشگاه',
] );
...
define( 'LS_PLUGIN_META', [
    ...
    'daftarchi' => [
        'icon' => '📒',
        'desc' => 'دفترچی — حسابداری دسکتاپ، شارژ دوره‌ای روی یک سیستم',
    ],
] );
