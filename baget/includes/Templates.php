...
class Templates {
	...
	public static function css_for( $key ) {
		...
		return "body{font-family:Vazirmatn,Tahoma,sans-serif;background:{$bg};margin:0;padding:24px;color:{$text}}"
			...
			. ".wccp-field{display:flex;flex-direction:column;gap:6px;margin-bottom:12px;font-size:13px;color:{$muted}}"
			. ".wccp-field-label{font-weight:600;color:{$text}}"
			...
			. ".wccp-choice-list{display:flex;flex-direction:column;gap:8px;margin-top:4px}"
			. ".wccp-choice{display:flex;align-items:center;gap:8px;padding:10px 12px;border:1px solid rgba(100,116,139,.3);border-radius:12px;background:transparent;cursor:pointer;font-weight:500;color:{$text}}"
			...
			. ".wccp-price{font-weight:700;color:{$prim}}"
